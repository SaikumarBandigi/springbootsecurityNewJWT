...
WebSecurityConfigurerAdapter {
	...
	public AuthenticationManager authenticationManagerBean() throws Exception{
		...
		//Creating our own Authentication Manager becuase when we send token it should create authenication Object
	...
	{
		//Creating Our own Once per RequestFilter ==> As framework does not know about encryptiong and decryption
	...
	protected void configure(HttpSecurity httpsecurity) throws Exception{
		...
		//Registraiong and login ==> Should not authorize
